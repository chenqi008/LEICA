...
# ====================================================
# (Step 1)
data_path=/home/qichen/Desktop/Evaluation/MyEvaluation/run_scripts/image_gen/toy_data/coco_karpathy_split/debug/validation_set_part_unipair
...
score_filepath=${data_path}/scores_fin_woall.txt
