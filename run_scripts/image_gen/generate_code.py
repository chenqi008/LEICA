...
class VQGANDataset(Dataset):
    def __init__(self, file, selected_cols, code_image_size):
        ...
        self.code_resize_transform = transforms.Compose([
            ...
            transforms.Resize(code_image_size, interpolation=Image.LANCZOS),
            transforms.ToTensor(),
            preprocess_vqgan
        ])
...
if __name__ == "__main__":
    ...
    dataset = VQGANDataset(args.file, args.selected_cols, args.code_image_size)
