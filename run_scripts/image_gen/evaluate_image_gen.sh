...
data=./toy_data/mismatch/custom_data_code.txt
...
# CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=4 --master_port=${MASTER_PORT} ../../evaluate.py \
...
# pip install scipy
# compute IS
# python inception_score.py --gpu 0 --batch-size 128 --path1 ${GEN_IMAGE_PATH}/top1
...
# python fid_score.py --gpu 0 --batch-size 128 --path1 ${GEN_IMAGE_PATH}/top1 --path2 ./gt_stat.npz