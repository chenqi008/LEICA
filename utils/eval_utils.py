...
def eval_image_gen(task, generator, models, sample, cfg, **kwargs):
    # hypos, _ = task.inference_image(generator, sample, models)
    hypos, probs_list = task.inference_image(generator, sample, models, cfg)
    ...
    # return results, scores
    return results, scores, probs_list
...
def eval_step(task, generator, models, sample, cfg, **kwargs):
    if task.cfg._name == 'caption':
        ...
        return eval_image_gen(task, generator, models, sample, cfg, **kwargs)
